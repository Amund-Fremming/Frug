...
import { styles, imageStyle } from "./SpinPlanetStyles.js";

export default function SpinPlanets() {
  ...
  const planetOne = require("../../assets/images/planets/bluePlanet.webp");
  const planetTwo = require("../../assets/images/planets/orangePlanet.webp");
  const planetThree = require("../../assets/images/planets/greenPlanet.webp");
